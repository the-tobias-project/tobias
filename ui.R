  ...
  tabItems(
    ...
    tabItem(tabName = "predict",
            ...
            fluidRow(
              ...
              column(width = 6,
                     box(width = NULL,
                         title = "Alternative Model", status = "primary", solidHeader = TRUE,
                         selectizeInput("pop_predict_model", "Choose Alternative model populations", choices = pops, multiple=TRUE),
